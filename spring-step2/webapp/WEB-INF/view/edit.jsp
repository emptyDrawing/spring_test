  ...
  <div class="container-fluid">
	...
	<form action="update.bit" method="post">
		<div class="form-group">
			<label for="sabun">sabun</label><div class="well well-sm">${bean.sabun }</div>
		...
		<div class="form-group">
			<label for="nalja">nalja</label><div class="well well-sm">${bean.nalja }</div>
			<input type="hidden" value="${bean.nalja }" id="nalja" class="form-control" readonly="readonly"/>
		</div>
		<div class="form-group">
