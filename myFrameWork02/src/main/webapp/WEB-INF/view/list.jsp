...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-hover">
					<thead>
						<tr>
							<th>사번</th><th>이름</th><th>날짜</th><th>금액</th></tr>
					</thead>
					<tbody>
				...
				<a class="btn btn-primary" href="add.do" role="button">Add</a>
		...
		<div class="row">
			<div class="col-md-12">
				<!-- footer start -->
				<p class="text-center text-uppercase">CopyRight &copy; 빈그림. 2018. 테스트용 페이지.</p>
